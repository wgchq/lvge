...
public class LogUtil {
    ...
    private static Boolean LOG_TO_FILE = BuildConfig.DEBUG; // 日志写入文件开关
    private static String LOG_TAG = "Loyo"; // 默认的tag
...
//        LOG_FILE_PATH = MainApp.getMainApp().getCacheDir().getPath()+File.separator+"Logs";
//        LOG_FILE_PATH = Environment.getExternalStorageDirectory().getPath() + File.separator + MainApp.getMainApp().getPackageName();
        LOG_FILE_PATH = Environment.getExternalStorageDirectory().getPath() + File.separator + "Android"+ File.separator+"data"+ File.separator+ AppUtil.getAppContext().getPackageName();
        LOG_FILE_NAME = "Log";
        Log.i(LOG_TAG,"LOG_FILE_PATH: "+LOG_FILE_PATH);
//        Log.i(LOG_TAG,"BuildConfig.DEBUG: "+BuildConfig.DEBUG);
    }
