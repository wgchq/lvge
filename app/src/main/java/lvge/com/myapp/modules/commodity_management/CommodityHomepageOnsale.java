...
import lvge.com.myapp.modules.message_management.SystemMessageAdapter;
import lvge.com.myapp.util.NetworkUtil;
import okhttp3.Response;

public class CommodityHomepageOnsale extends Fragment {

    private View view;
    CommodityHomepageOnsaleAdapter adapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
    {
        ...
        adapter = new CommodityHomepageOnsaleAdapter(getActivity());
