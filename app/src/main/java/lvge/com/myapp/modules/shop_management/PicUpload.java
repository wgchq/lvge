...
public class PicUpload {
    ...
    public String imgPut(String path, List<String> filePaths, String filetype, String type, String pictureID) throws Exception {
...
//            }
            ...
            sb.append("\r\n").append("--").append(BOUNDARY).append("\r\n");
            sb.append("Content-Disposition: form-data; name=\"fileTypes\"\r\n\r\n");
            sb.append(filetype);

            if("".equals(pictureID) || pictureID.isEmpty())

                L.d("pictureID: null");
            else{

                L.d("pictureID:"+pictureID);
                sb.append("\r\n").append("--").append(BOUNDARY).append("\r\n");
                sb.append("Content-Disposition: form-data; name=\"pictureIDs\"\r\n\r\n");
                sb.append(pictureID);
            }
