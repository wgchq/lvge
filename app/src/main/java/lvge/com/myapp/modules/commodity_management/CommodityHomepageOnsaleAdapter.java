...
import lvge.com.myapp.modules.customer_management.HolderKilometerActivity;
...
public class CommodityHomepageOnsaleAdapter extends BaseAdapter {
    ...
    public CommodityHomepageOnsaleAdapter(Context context) {
