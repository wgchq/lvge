...
public class CommodityHomepageShelffailure extends Fragment {
    private View view;
    CommodityHomepageShelffailureAdapter adapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
    {
        ...
        adapter = new CommodityHomepageShelffailureAdapter(getActivity());
